                    ...
                    if (dataGridView1.RowCount > 0)
                    {
                        ...
                        if (msg == DialogResult.Yes)
                        {
                            ...
                            for (i = 0; i <= dataGridView1.RowCount - 1; i++)
                            {
                                ...
                                clsUtility.ExecuteSQLQuery(" INSERT INTO ItemInformation (ItemName,  UnitOfMeasure, Batch,  GROUP_ID,  Barcode,  Cost,  Price,  ReorderPoint, VAT_Applicable,  WarehouseID,Weight_per_piece,Promotiontype) VALUES " +
                                                           " ('" + ItemName + "',  '" + UnitOfMeasure + "', '" + Batch + "',  '" + GROUP_ID + "',  '" + Barcode + "',  '" + Cost + "',  '" + Price + "',  '" + ReorderPoint + "', '" + VAT_Applicable + "',  '" + Weight + "', '" + Promotiontype + "') ");
