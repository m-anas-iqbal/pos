...
//Database    : SQLite
//Database URL: https://www.sqlite.org/index.html
//=======================================================
...
namespace Orion
{
    class clsUtility
    {
        ...
        {
            SQLiteConnection conn = new SQLiteConnection(CnString);
            try
            {
                conn.Open();
        ...
        {
            DataTable dt = new DataTable();
            using (var connection = new SQLiteConnection(CnString))
            {
        ...
        public static void Preview__TaxInvoice(string sql, CrystalReportViewer CrystalReportViewer)
        {
            ...
            My_Connection = new SQLiteConnection(CnString);
