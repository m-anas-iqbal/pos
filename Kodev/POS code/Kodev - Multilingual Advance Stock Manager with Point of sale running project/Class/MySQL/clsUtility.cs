...
//Database    : MYSQL
//Database URL: https://www.mysql.com/
//=======================================================
...
namespace Orion
{
    class clsUtility
    {
        ...
        public static DataTable ExecuteSQLQuery(string SQLQuery)
        {
            try
            {
                MySqlConnection sqlCon = new MySqlConnection(CnString);
        ...
        public static void Preview__TaxInvoice(string sql, CrystalReportViewer CrystalReportViewer)
        {
            ...
            MySqlConnection My_Connection = default(MySqlConnection);
            MySqlCommand my_Command = new MySqlCommand();
            MySqlDataAdapter my_DataAdapter = new MySqlDataAdapter();
            dsOrion my_DataSource = new dsOrion();
            My_Connection = new MySqlConnection(CnString);
