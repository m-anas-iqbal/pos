...
namespace Kodev
{
    public partial class frmListOfItem : Form
    {
        ...
        private void LoadData() {
            clsUtility.FillDataGrid(" SELECT ITEM_ID, ItemName,Promotiontype, UnitOfMeasure,Weight_per_piece, Batch, GROUP_NAME, Barcode, Cost,  Price,  ReorderPoint,  VAT_Applicable, WarehouseID " +
        ...
        private void btnSearchByGroup_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    clsUtility.FillDataGrid(" SELECT ITEM_ID, ItemName, UnitOfMeasure,Weight_per_piece, Batch, GROUP_NAME, Barcode, Cost,  Price,  ReorderPoint,  VAT_Applicable, WarehouseID " +
