...
namespace Kodev
{
    public partial class frmCustomerInfo : Form
    {
        ...
        {
            clsUtility.FillDataGrid(" SELECT customer.CUST_ID,CustomerName,Address,PhoneNo,Balance,OpeningDate,PhotoFileName,points,loyalty_no from Customer left join loyalty on loyalty.cust_id=Customer.CUST_ID ", dataGridView1);
        }
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (clsUtility.sqlDT.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    clsUtility.ExecuteSQLQuery(" INSERT INTO loyalty (cust_id,points) VALUES " +
                                               " ('" + CUST_ID + "','" + 5 + "') ");
