...
namespace Kodev
{
    ...
    public static DataTable ExecuteSQLQuery2(string SQLQuery)
        ...
        public static void Preview__SalesReceipt(string sql, CrystalReportViewer CrystalReportViewer)
        {
            ...
            ParamCollection.Add(crpredeem_pt);
            rpt_Document.ParameterFields["redeem_pt"].CurrentValues = ParamCollection;
        ...
        public static void ReportLanguegePack()
        {
            ...
            else
            {
                ...
                crpUnitVat.Value = "UNIT TAX";
                crpTotalVat.Value = "TOTAL TAX";
                crpTaxInv.Value = "TAX INVOICE";
                crpRcpVat.Value = "TAX";
                crpRcpNotice.Value = "GOODS ONCE SOLD CAN’T BE RETURNED OR EXCHANGE.";
                crpStock.Value = "STOCK";
                crpredeem_pt.Value = "Points redeem";
            }
        }


        //Crystal Reports Parameters
        public static CrystalDecisions.Shared.ParameterDiscreteValue crpredeem_pt = new CrystalDecisions.Shared.ParameterDiscreteValue();
